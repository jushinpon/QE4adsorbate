...
my $dir = "$currentPath/data4QEinput";      #改
# my $dir = "$currentPath/data4relax";      #改data4relax
...
`rm -rf data2QE4MatCld`;        #改
`mkdir data2QE4MatCld`;         #改
...
#1 1 1.000000 4.458517505863 1.201338326940 0.873835074284 with charge
    ...
    my %QE_para = (
            ...
            output_file => "$currentPath/data2QE4MatCld/$QEoutput",     #改
